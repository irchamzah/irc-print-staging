...
// GET /api/hub/partner-withdrawals - Get partner withdrawals
export async function GET(request) {
  try {
    const { searchParams } = new URL(request.url);

    const vpsUrl = new URL(
      `${NEXT_PUBLIC_VPS_API_URL}/api/hub/partner-withdrawals`,
    );
...
// POST /api/hub/partner-withdrawals - Create withdrawal request
