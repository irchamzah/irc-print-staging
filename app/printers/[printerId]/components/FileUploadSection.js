  ...
  return (
    <>
      <div className="flex justify-center animate-pulse">
        <a
          href="https://drive.google.com/drive/folders/1vsmihRxRCRLuP8TVbRnD5exJfMpWY4_c"
          target="_blank"
        >
          <span className="text-blue-500 text-sm underline font-bold">
            Lihat Tutorial Print
          </span>
        </a>
      </div>
